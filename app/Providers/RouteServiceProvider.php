...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            Route::middleware('web')
                ->namespace($this->namespace)
                ->group(base_path('routes/search_profiles.php'));
            ...
            Route::middleware('web')
                ->namespace($this->namespace)
                ->group(base_path('routes/registration_admission_academic_transcripts.php'));

            Route::middleware('web')
                ->namespace($this->namespace)
                ->group(base_path('routes/RegisterAdmissions/talent.php'));
